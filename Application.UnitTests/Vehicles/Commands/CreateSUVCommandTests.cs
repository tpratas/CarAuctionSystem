...
public class CreateSUVCommandTests
{
    [Fact]
    public async Task Handle_Existing_SUV_On_Inventory()
    {
        ...
        var handler = new CreateSUVCommandHandler(mockRepository.Object, mockMapper.Object);
        var command = new CreateSUVCommand();
