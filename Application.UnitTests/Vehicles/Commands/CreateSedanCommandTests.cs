...
public class CreateSedanCommandTests
{
    [Fact]
    public async Task Handle_Existing_Sedan_On_Inventory()
    {
        ...
        var handler = new CreateSedanCommandHandler(mockRepository.Object, mockMapper.Object);
        var command = new CreateSedanCommand();
